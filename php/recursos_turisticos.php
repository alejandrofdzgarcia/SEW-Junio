<?php
/**
 * recursos_turisticos.php - Muestra el catálogo de recursos turísticos disponibles
 * 
...
// Comprobar si el usuario está logueado (para mostrar opciones adicionales)
...
try {
    ...
    // Consultar los recursos turísticos disponibles
